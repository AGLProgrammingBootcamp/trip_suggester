...
class FindersControllerTest < ActionController::TestCase
  ...
  test "should create finder" do
    assert_difference('Finder.count') do
      post :create, finder: { hotel_id: @finder.hotel_id, hotel_name: @finder.hotel_name, hotel_sample_fare: @finder.hotel_sample_fare, onsen_name: @finder.onsen_name }
    end
  ...
  test "should update finder" do
    patch :update, id: @finder, finder: { hotel_id: @finder.hotel_id, hotel_name: @finder.hotel_name, hotel_sample_fare: @finder.hotel_sample_fare, onsen_name: @finder.onsen_name }
    assert_redirected_to finder_path(assigns(:finder))
  end
